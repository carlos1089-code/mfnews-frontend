...
import { 
    Typography, Box, Chip, Stack, Paper, Alert,
    TextField, InputAdornment 
} from '@mui/material';
// Usamos Grid (que en MUI v6 ya es el Grid2 por defecto)
import Grid from '@mui/material/Grid'; 
import AccessTimeIcon from '@mui/icons-material/AccessTime';
import SearchIcon from '@mui/icons-material/Search'; 

// Importaciones limpias (sin .tsx/.ts)
            ...
            heroNews && ( 
                <Grid container spacing={4}> 
                    ...
                    {/* === HERO (Noticia Principal) === 
                        CORRECCIÓN: Quitamos 'item' y usamos 'size={{...}}'
                    */}
                    ...
                    */}
                    ...
                    {/* === GRILLA INFERIOR === 
                        CORRECCIÓN: size={{ xs: 12 }} para el contenedor
                    */}
                    <Grid size={{ xs: 12 }}>
